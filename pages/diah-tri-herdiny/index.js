    ...
    <>
      <div>
        ...
        <div className="flex flex-col items-center justify-center font-popin pt-12">
          <h1 className="font-bold">Diah Tri Herdiny</h1>
          <h1>Sales Support Specialist</h1>
        </div>
        ...
        <div className="flex items-center justify-center">
          <div className="grid grid-cols-3 gap-10 mt-10">
            <div className="bg-white border rounded-full p-2 w-[45px] flex items-center justify-center">
              <Link
                href="https://www.linkedin.com/in/diah-tri-herdiny-061a4b16b"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaLinkedin size={25} />
            ...
            <div className="bg-white border rounded-full p-2 w-[45px] flex items-center justify-center">
              <Link
                href="mailto:diahtri.herdini@amital.co.id"
                target="_blank"
                rel="noopener noreferrer"
              >
                <SiGmail size={25} />
            ...
            <div className="bg-white border rounded-full p-2 w-[45px] flex items-center justify-center">
              <Link
                href="https://wa.me/6282111340741"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaWhatsapp size={25} />
