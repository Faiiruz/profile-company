    ...
    <>
      <div>
        ...
        <div className="flex flex-col items-center justify-center font-popin pt-12">
          <h1 className="font-bold">Alya Salsabila Azhar</h1>
        ...
        <div className="flex items-center justify-center">
          <div className="grid grid-cols-3 gap-10 mt-10">
            <div className="bg-white border rounded-full p-2 w-[45px] flex items-center justify-center">
              <Link
                href="https://www.linkedin.com/in/alya-salsabila-azhar-5a8b521b3/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaLinkedin size={25} />
            ...
            <div className="bg-white border rounded-full p-2 w-[45px] flex items-center justify-center">
              <Link
                href="mailto:alya.salsabila@amital.co.id"
                target="_blank"
                rel="noopener noreferrer"
              >
                <SiGmail size={25} />
            ...
            <div className="bg-white border rounded-full p-2 w-[45px] flex items-center justify-center">
              <Link
                href="https://wa.me/6281213120827"
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaWhatsapp size={25} />
